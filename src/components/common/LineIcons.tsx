...
const GLYPHS: Record<string, React.ReactNode> = {
  ...
  key: <><circle cx="7.5" cy="15.5" r="4.5" /><path d="M10.7 12.3L21 2" /><path d="M15.5 7.5l3 3" /><path d="M18.5 4.5l2 2" /></>,
  ...
  live: <><circle cx="12" cy="12" r="2" fill="currentColor" stroke="none" /><path d="M8.5 15.5a5 5 0 0 1 0-7" /><path d="M15.5 8.5a5 5 0 0 1 0 7" /><path d="M5.6 18.4a9 9 0 0 1 0-12.8" /><path d="M18.4 5.6a9 9 0 0 1 0 12.8" /></>,
