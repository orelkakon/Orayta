...
const AppTitle = styled.h1`
  ...
  font-size: 2.4rem; font-weight: 700; color: ${theme.colors.primary};
`;
...
const QuoteText = styled.p`
  font-family: ${theme.fonts.body};
  font-size: 1.05rem; color: ${theme.colors.textMuted};
...
export default function HomeView() {
  return (
    <Page>
      <Hero>
        <LogoRing><OraytaLogo size={64} /></LogoRing>
      ...
      {/* Scrolling dedications ticker stays right below the hero */}
